...
Build
Status](https://travis-ci.org/kbenoit/spacyr.svg?branch=master)](https://travis-ci.org/kbenoit/spacyr)
[![Appveyor Build
...
[![codecov.io](https://codecov.io/github/kbenoit/spacyr/coverage.svg?branch=master)](https://codecov.io/gh/kbenoit/spacyr/branch/master)
...
[issues](https://github.com/kbenoit/spacyr/issues) page, and/or send us
...
``` r
library("spacyr")
spacy_initialize(python_executable = "/anaconda/bin/python3")
...
[**quanteda**](http://githiub.com/kbenoit/quanteda) also work on the new
