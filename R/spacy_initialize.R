...
#' @param check_env logical; check whether conda/virtual environment 
#'   generated by \code{spacyr_istall()} exists
...
#' @param save_profile logical; if \code{TRUE}, the current spacy setting will be saved for the future use. 
#'   
#' @export
