...
3. Install spaCy with **Administrator Command Line**. 
    1. Installtion of spaCy requires an administrator privilege as it generates symbolic links outside the user folder. In order to start it you need to do:
...
If you have more than one python executables (i.e. having python 2.\*), you need to set the python path correctly. 